...
export default function Contact() {
  ...
  const handleSubmit = (e) => {
    ...
    window.location.href = `mailto:support@formphoto.in?subject=${subject}&body=${body}`;
    setSent(true);
  };
  ...
  return (
    <div className="legal-page">
      ...
      <p>
        ...
        email <a href="mailto:support@formphoto.in">support@formphoto.in</a>.
      </p>
      ...
      <div className="legal-card">
        {sent ? (
          <p style={{ color: 'var(--color-primary)', margin: 0 }}>
            ...
            support@formphoto.in directly. Thank you!
          </p>
        ) : (
