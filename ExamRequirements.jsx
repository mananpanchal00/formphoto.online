  ...
  return (
    <div className="exam-req-page">
      ...
      <header className="exam-req-header">
        <h1>Photo &amp; Signature Requirements</h1>
        <p className="exam-req-sub">
          Exact pixel sizes and file limits for Indian government exams, entrance tests, banking
          jobs and ID documents. Always double-check the official notification for the latest rules.
        </p>
