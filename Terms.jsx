...
export default function Terms() {
  return (
    <div className="legal-page">
      ...
      <p>
        By using FormPhoto (formphoto.in), you agree to these Terms of Service. If you do not agree,
      ...
      <h2>8. Contact</h2>
      <p>
        For questions: <a href="mailto:support@formphoto.in">support@formphoto.in</a> or{' '}
