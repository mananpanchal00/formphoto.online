    ...
    <div className="page-container sig-resizer-page">
      ...
      <header className="page-header">
        ...
        <p className="subtitle">
          Format your digital signature to exact exam/bank requirements. Clean ink, white
          background, and correct size in one click.
        </p>
      </header>
      ...
      <div className="tool-layout">
        <div className="controls-column glass-panel">
          ...
          <button
            type="button"
            className={`primary-button large-button ${processing ? 'processing' : ''}`}
