...
// Dynamic import of pdf-lib from CDN so no local install is required
    ...
    <div className="page-container image-to-pdf-page">
      ...
      <header className="page-header">
        ...
        <p className="subtitle">
          Convert one or more images into a single PDF. Perfect for forms, documents and sharing.
        </p>
      </header>
      ...
      <div className="tool-layout">
        <div className="controls-column glass-panel">
          ...
          <button
            className={`primary-button large-button hero-btn ${processing ? 'processing' : ''}`}
